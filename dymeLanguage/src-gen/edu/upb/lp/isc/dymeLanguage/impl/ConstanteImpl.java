 ...
 * </p>
 * <ul>
 *   <li>{@link edu.upb.lp.isc.dymeLanguage.impl.ConstanteImpl#getNombre <em>Nombre</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConstanteImpl extends ExpresionImpl implements Constante
{
  ...
  {
    return DymeLanguagePackage.Literals.CONSTANTE;
  }
    ...
    if (nombre != null && nombre.eIsProxy())
    {
      ...
      if (nombre != oldNombre)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DymeLanguagePackage.CONSTANTE__NOMBRE, oldNombre, nombre));
      }
    }
    return nombre;
  }
