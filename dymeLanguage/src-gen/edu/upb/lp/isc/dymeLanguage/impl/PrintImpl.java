 ...
 * </p>
 * <ul>
 *   <li>{@link edu.upb.lp.isc.dymeLanguage.impl.PrintImpl#getPrintTipo <em>Print Tipo</em>}</li>
 *   <li>{@link edu.upb.lp.isc.dymeLanguage.impl.PrintImpl#getVal <em>Val</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrintImpl extends DeclaracionImpl implements Print
{
  ...
  {
    return DymeLanguagePackage.Literals.PRINT;
  }
  ...
  public void setPrintTipo(String newPrintTipo)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DymeLanguagePackage.PRINT__PRINT_TIPO, oldPrintTipo, printTipo));
  }
  ...
  public NotificationChain basicSetVal(Valor newVal, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DymeLanguagePackage.PRINT__VAL, oldVal, newVal);
  ...
  public void setVal(Valor newVal)
  {
    if (newVal != val)
    {
      ...
      if (val != null)
        msgs = ((InternalEObject)val).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DymeLanguagePackage.PRINT__VAL, null, msgs);
      if (newVal != null)
        msgs = ((InternalEObject)newVal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DymeLanguagePackage.PRINT__VAL, null, msgs);
      msgs = basicSetVal(newVal, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DymeLanguagePackage.PRINT__VAL, newVal, newVal));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DymeLanguagePackage.PRINT__VAL:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DymeLanguagePackage.PRINT__PRINT_TIPO:
        return getPrintTipo();
      case DymeLanguagePackage.PRINT__VAL:
        return getVal();
    }
